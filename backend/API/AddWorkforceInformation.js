...
module.exports = function(db) {
    ...
    router.post('/AddWorkforceInformation', async (req, res) => {
        try {
            const { national_id, nameprefix, full_name, age, sex, email, telephone_number, secondarycontact, address, jobexperience, salary, totalvacationdays, start_work_date, end_of_work_day ,  update_record } = req.body;
            const query = `
                ...
                RETURNING *; 
            `;
            const values = [ national_id, nameprefix, full_name, age, sex, email, telephone_number, secondarycontact, address, jobexperience, salary, totalvacationdays, start_work_date, end_of_work_day ,  update_record ];
    ...
    router.put('/UpdateWorkforceInformationdata/:id', async (req, res) => {
        try {
            ...
            const query = `
                ...
                RETURNING *;
            `;
            const values = [national_id, nameprefix, full_name, age, sex, email, telephone_number, secondarycontact, address, jobexperience, salary, totalvacationdays, start_work_date, end_of_work_day ,  update_record , id ];
